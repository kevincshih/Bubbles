package com.kcs.bubbles.tests;

import com.kcs.bubbles.BubbleActivity;
...
public class BubbleActivityMultiple extends
	...
	public void testRun() {
		...
		solo.waitForActivity(com.kcs.bubbles.BubbleActivity.class, delay);

		// Set Still Mode
		solo.clickOnActionBarItem(com.kcs.bubbles.R.id.menu_still_mode);
		...
		assertEquals("Bubble hasn't appeared", 1, solo.getCurrentViews(com.kcs.bubbles.BubbleActivity.BubbleView.class).size());
		...
		// Assert that a bubble was displayed 
		assertEquals("Second bubble hasn't appeared", 2, solo.getCurrentViews(com.kcs.bubbles.BubbleActivity.BubbleView.class).size());
		...
		assertEquals(
				...
				solo.getCurrentViews(
						com.kcs.bubbles.BubbleActivity.BubbleView.class)
						.size());
	}
}
