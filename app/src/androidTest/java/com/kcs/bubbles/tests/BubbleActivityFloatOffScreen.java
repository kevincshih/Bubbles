...
public class BubbleActivityFloatOffScreen extends
	...
	public void testRun() {
		...
		solo.waitForActivity(com.kcs.bubbles.BubbleActivity.class,
				delay);

		// Click on action bar item
		solo.clickOnActionBarItem(com.kcs.bubbles.R.id.menu_single_speed);
		...
		boolean bubbleAppeared = solo.getCurrentViews(
				com.kcs.bubbles.BubbleActivity.BubbleView.class).size() > 0;
